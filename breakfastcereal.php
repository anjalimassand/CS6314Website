...
<head>
    ...
    <title>Shopper's Stop: Breakfast & Cereal</title>
    <header>
        ...
        <div class="column2" style="background-color:aliceblue">
            <div>
                ...
                <?php
                    ...
                    $sql = "SELECT ItemNumber, Name, Category, Subcategory, UnitPrice, QuantityInInventory, ImageSrc FROM Inventory WHERE Category = 'Breakfast'";
