        ...
        <div class="column2" style="background-color:aliceblue">
            <div>
                ...
                <div class="foodContainer" id="foodContainer">
                    ...
                    $sql = "SELECT ItemNumber, Name, Category, Subcategory, UnitPrice, QuantityInInventory, ImageSrc FROM Inventory WHERE Category = 'Snacks'";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<div class="card" name="' . strtolower($row['Name']) . '">';
